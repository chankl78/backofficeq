...
class AccessMRoleAccessRightsTable extends Migration
{
    public function up()
    {
        Schema::create('Access_m_RoleAccessRights', function (Blueprint $table) {
            $table->increments('id');
        ...
        Log::info("[Migration] Table Access_m_RoleAccessRights created!");
    }

    public function down()
    {
        Schema::dropIfExists('Access_m_RoleAccessRights');
        Log::warning("[Migration] Table Access_m_RoleAccessRights deleted!");
    }
}
